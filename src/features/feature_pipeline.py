...
class FeaturePipeline:
    ...
    def get_feature_names(self) -> list[str]:
        ...
        features = ['lag_1d', 'lag_7d', 'lag_14d', 'lag_30d', 'roll_mean_3d', 'roll_mean_7d', 
                    'roll_std_7d', 'ewma_7d', 'day_of_week', 'is_weekend', 'month', 'sin_dow', 
                    'cos_dow', 'is_holiday', 'days_to_holiday', 'store_id_enc']
        if self.freq == 'H':
