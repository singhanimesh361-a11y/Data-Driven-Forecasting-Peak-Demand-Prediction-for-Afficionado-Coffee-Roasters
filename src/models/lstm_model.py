...
class LSTMForecaster(BaseForecaster):
    ...
    def fit(
        self, df: pd.DataFrame, feature_cols: List[str], target_col: str = "total_revenue", **kwargs: Any
    ) -> "LSTMForecaster":
        ...
        for sid in store_ids:
            ...
            def objective(trial):
                ...
                model = LSTMNet(
                    input_size=len(self.feature_cols), hidden_size=hidden_size, num_layers=num_layers, dropout=dropout
                )
